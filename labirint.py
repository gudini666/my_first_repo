...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet('kff.png',self.rect.right, self.rect.centery, 15, 20, 15)
        bullets.add(bullet)
...
w2 = GameSprite('wall.jpg', 500, 360, 500, 50)
w3 = GameSprite('wall.jpg', 500, 0, 50, 280)
w4 = GameSprite('wall.jpg', 200, 360, 100, 50)
w5 = GameSprite('wall.jpg', 700, 160, 50, 200)
w6 = GameSprite('wall.jpg', 200, 410, 50, 400)
w7 = GameSprite('wall.jpg', 950, 410, 50, 300)
w8 = GameSprite('wall.jpg', 1100, 500, 400, 50)
...
final_sprite = GameSprite('tron.png', win_width - 85, win_height - 100, 80, 80)
 
monster1 = Enemy('gg.png', 100, 100, 80, 80, 10)
